...
function HubList() {
  ...
  return (
    <Container>
      ...
      <h1 className="text-center my-5">Debate Hubs</h1>
      <h4 className="text-center my-5">Debate Hub is a space where passionate individuals come together to discuss and share their thoughts on various topics. 
       ...
       <br></br>Click on any of the hubs below to enter a conversation and start sharing your insights. Whether you agree, disagree, or simply want to learn more, your voice matters here!</h4>
      <InfiniteScroll
